...
@InputType()
class UserProjectCreateNestedManyWithoutProjectsInput {
...
export { UserProjectCreateNestedManyWithoutProjectsInput as UserProjectCreateNestedManyWithoutProjectsInput };
